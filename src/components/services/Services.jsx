...
const Services = () => {
  ...
  return (
    <section className="services section" id="services">
        ...
        <h2 style = {{ fontSize: '36px' }} className='section_title'>Services</h2>
        <span className='section_subtitle'>What i offer</span> {/*haha for now */}</div>

        <div className="services_container container grid">
            <div className="services_content">
                <div>
                    <i className="uil uil-web-grid services_icons"></i>
                ...
                <div className={toggleState === 1 ? "services_modal active-modal" : "services_modal"}>
                    <div className="services_modal-content">
                        ...
                        <p className="services_modal-description">Services description should change it accordingly</p>

                        <ul className="services_modal-services grid">
                            <li className="services_modal-service">
                                <i className="uil uil-check-circle services_modal-icon"></i>
                                <p className="services_modal-info">Website Development</p>
                            </li>

                            <li className="services_modal-service">
                                <i className="uil uil-check-circle services_modal-icon"></i>
                                <p className="services_modal-info">Automating projects -  automating the stuff</p>
                            </li>

                            <li className="services_modal-service">
                                <i className="uil uil-check-circle services_modal-icon"></i>
                                <p className="services_modal-info">AI and ML Projects</p>
                            </li>

                            <li className="services_modal-service">
                                <i className="uil uil-check-circle services_modal-icon"></i>
                                <p className="services_modal-info">Networking</p>
                            </li>

                            <li className="services_modal-service">
                                <i className="uil uil-check-circle services_modal-icon"></i>
                                <p className="services_modal-info">Cloud</p>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div className="services_content">
                <div>
                    <i className="uil uil-arrow services_icons"></i>
            ...
            <div className="services_content">
                <div>
                    <i className="uil uil-edit services_icons"></i>
